...
import { L1TransactionReceipt, L1ToL2MessageStatus, getRawArbTransactionReceipt, L1ToL2MessageWriter } from '@arbitrum/sdk'
...
const checkAndRedeemMessage = async (l1ToL2Message: L1ToL2MessageWriter, l2Provider: JsonRpcProvider) => {
