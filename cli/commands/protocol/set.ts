...
export const settersList = {
  ...
  'l1-gateway-set-arbitrum-addresses': { contract: 'L1GraphTokenGateway', name: 'setArbitrumAddresses' },
  'l1-gateway-set-l2-counterpart': { contract: 'L1GraphTokenGateway', name: 'setL2CounterpartAddress' },
  ...
  'l2-gateway-set-l1-counterpart': { contract: 'L2GraphTokenGateway', name: 'setL1CounterpartAddress' },
