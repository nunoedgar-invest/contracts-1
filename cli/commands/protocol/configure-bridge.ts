...
const l1ToL2ChainIdMap = {
  '1': '42161',
  '4': '421611'
}
const l2ToL1ChainIdMap = {
  '42161': '1',
  '421611': '4'
}
...
export const configureL1Bridge = async (cli: CLIEnvironment, cliArgs: CLIArgs): Promise<void> => {
  ...
  logger.info("L1 Inbox address: " + l1Inbox.address + " and L1 Router address: " + l1Router.address)
  await sendTransaction(cli.wallet, gateway, 'setArbitrumAddresses', [l1Inbox.address, l1Router.address])
}
